...
const sendMail = (req, res = response) => {
    ...
    const mailOptions = {
        ...
        html: `<header id="main" class="coverage" style="background-image: url('../assets/header-coverage.webp'); width: 600px; height: 143px; background-repeat: no-repeat; background-size: cover; background-position: 50% 100%; color: #FFFFFF; font-weight: 600; font-family: 'Manrope', serif;">
    ...
    <main style="font-family: 'Manrope', serif;">
        <section style="padding: 32px;">
            ...
            <a href="#" id="btn-lets-chat" style="display: block; margin: 20px auto; padding: 12px 22px;  background-color: #1313B6; color: #FFFFFF; border: none; border-radius: 60px; height: 46px; width: 123px; font-size: 16px; line-height: 21.86px; font-weight: 500; text-decoration: none;">
                Let’s chat!
            </a>
